 ...
 */
public class ESP8266FSMake implements Tool {
    Editor editor;
    ...
    public String getMenuTitle() {
        return "ESP8266 Sketch Data Make";
    }
    ...
    private void createAndUpload() {
        ...
        String imagePath = dataFolder.getAbsolutePath() + "/../" + sketchName + ".spiffs.bin";
        ...
        editor.statusNotice("SPIFFS Make Success");
        System.out.println("[SPIFFS] imagePath  : " + imagePath);
        System.out.println("[SPIFFS] address  : " + uploadAddress);
        System.out.println("[SPIFFS] SPIFFS Make Success");
        System.out.println();
